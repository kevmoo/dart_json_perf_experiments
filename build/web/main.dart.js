...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    }, "call$2", "core_Comparable_compare$closure", 4, 0, 16],
    ...
    "^": ""
  }], ["data", "package:djs/data.dart",, B, {
    "^": "",
    Data: {
      "^": "Object__$DataSerializerMixin;count,first,last,strong>"
    },
    _$DataSerializerMixin: {
      "^": "Object;"
    },
    Object__$DataSerializerMixin: {
      "^": "Object+_$DataSerializerMixin;"
    }
  }], ["interop", "package:djs/interop.dart",, X, {
    "^": "",
    parseJson: [function(input) {
      return self.JSON.parse(input);
    }, "call$1", "interop__parseJson$closure", 2, 0, 17],
    JSData: {
      "^": "JavaScriptObject;",
      "%": ""
    }
  }], ["", "package:djs/stats.dart",, Y, {
    "^": "",
    Stats: {
      "^": "Object;count,mean,median,max,min,standardDeviation,standardError",
      static: {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              ...
              F._getStats(2000, request, F.main___dartNative$closure());
              F._getStats(2000, request, X.interop__parseJson$closure());
              dartStats = F._getStats(2000, request, F.main___dartNative$closure());
              jsStats = F._getStats(2000, request, X.interop__parseJson$closure());
    ...
    }, "call$1", "main___dartNative$closure", 2, 0, 18],
    _dartJson: function(input, decode) {
      ...
      t1 -= 0;
      t2 = J.where$1$ax(decode.call$1(input), new F._dartJson_closure());
      if (t2.get$length(t2) !== 512)
        throw H.wrapException("boo!");
      t2 = $.Primitives_timerTicks.call$0();
      t2 = t2;
      return P.Duration$(0, 0, C.JSInt_methods.$tdiv((t2 - t1) * 1000000, $.Stopwatch__frequency), 0, 0, 0);
    },
    _getStats_closure: {
      "^": "Closure:2;input,decode",
      call$1: function(i) {
  ...
  J.get$strong$x = function(receiver) {
...
;
  ...
  $ = new Isolate();
  init.metadata = [];
  init.types = [{func: 1}, {func: 1, v: true}, {func: 1, args: [,]}, {func: 1, args: [,,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, args: [P.int,,]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [W.HttpRequest]}, {func: 1, ret: P.num}, {func: 1, ret: P.int, args: [P.Comparable, P.Comparable]}, {func: 1, ret: [P.List, X.JSData], args: [P.String]}, {func: 1, ret: [P.Iterable, B.Data], args: [P.String]}];
